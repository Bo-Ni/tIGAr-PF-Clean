...
MAINTAINER BoNi <boni.mechanics@gmail.com>
...
RUN pip3 install singledispatch networkx pulp
RUN pip3 install git+https://github.com/Bo-Ni/tIGAr-PF-Clean.git
RUN pip3 install https://bitbucket.org/dalcinl/igakit/get/master.tar.gz
...
# tensorflow
# ===========================================
# RUN /bin/bash -c "git clone https://bitbucket.org/dalcinl/igakit && \
#                   cd igakit && \
#                   python3 setup.py install --user"

# RUN /bin/bash -c "git clone https://github.com/david-kamensky/tIGAr.git && \
#                   export PYTHONPATH=/tIGAr/:$PYTHONPATH"
