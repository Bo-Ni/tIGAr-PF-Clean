...
class LoadStepper:
    ...
    def advance(self):
        ...
        self.t.t = self.tval
# -------------------------------------------------------------
# a LoadStepper with multiple time steps
class LoadStepper_Self:
    ...
    def __init__(self,DELTA_T1,DELTA_T2,t12,t=0.0):
        """
        Initializes the ``LoadStepper`` with a (pseudo)time step ``DELTA_T``
        and initial time ``t``, which defaults to zero.
        """
    ...
    def advance(self):
        ...
        Increments the loading.
        """
        if(self.tval<self.TimeToChange):
            self.tval += float(self.DELTA_T1)
        elif(self.tval>=self.TimeToChange):
            self.tval += float(self.DELTA_T2)
        self.t.t = self.tval
# -------------------------------------------------------------
